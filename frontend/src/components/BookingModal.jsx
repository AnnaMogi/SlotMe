...
const BookingModal = ({ room, date, startTime, onClose, onSuccess }) => {
  // Вычисляем время окончания (на 1 час позже начала)
  ...
  // Используем текущую дату если date не передана
